...
import com.example.game.databinding.CustompopupHeatBinding
import io.reactivex.rxjava3.android.schedulers.AndroidSchedulers
import io.reactivex.rxjava3.disposables.Disposable

class Fragment_CustomPopUpHeat : DialogFragment() {
    private lateinit var client: Client
    private lateinit var binding: CustompopupHeatBinding
    ...
    override fun onCreateView(
        ...
        binding = CustompopupHeatBinding.inflate(inflater)
        ...
        object : CountDownTimer(500, 500) {
            ...
            override fun onFinish() {
                if (client.connected) {
                    ...
                    binding.actionTitle.text = getString(R.string.heatWithServer)
                    /** слушатель сообщений от сервера */
                    ...
                    client.send(Client.HttpRequests.heat)
                } else {
                    /** сервер не подключен */
                    /** установка текста ожидания таймера закрытия */
                    binding.actionTitle.text = getString(R.string.heatNoServer)
