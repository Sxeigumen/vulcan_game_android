...
import com.example.game.databinding.CustompopupShineBinding
import io.reactivex.rxjava3.android.schedulers.AndroidSchedulers
import io.reactivex.rxjava3.disposables.Disposable

class Fragment_CustomPopUpShine : DialogFragment() {
    private lateinit var client: Client
    private lateinit var binding: CustompopupShineBinding
        ...
        object : CountDownTimer(500, 500) {
            ...
            override fun onFinish() {
                if (client.connected) {
                    ...
                    binding.actionTitle.text = getString(R.string.shineWithServer)
                    /** слушатель сообщений от сервера */
                    ...
                    client.send(Client.HttpRequests.shine)
                } else {
                    /** сервер не подключен */
                    /** установка текста ожидания таймера закрытия */
                    binding.actionTitle.text = getString(R.string.shineNoServer)
